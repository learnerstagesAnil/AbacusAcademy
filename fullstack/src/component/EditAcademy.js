...
export default class EditAcademy extends Component {
    constructor(props){
        super(props)
        this.state={
            academyname:"",
    ...
    handleSubmit=(event)=>{
        ...
        axios.put("http://localhost:8080/api/academy/{id}",this.state)
        .then(response=>{
      ...
      <div className="container">
        <div className="row">
            <form onSubmit={this.handleSubmit}>
                <h2 className="text-center m-4"style={{background:"#ADD8E6"}}>Edit Academy</h2>
                ...
                <input type="text" value={this.state.academydescription} onChange={this.academydescriptionhandler} name="academydescription" placeholder="enter academydescription"/><br  />

      ...
      <div className="container">
        <div className="row">
            <form onSubmit={this.handleSubmit}>
                <h1 className="text-center m-4" style={{background:"#ADD8E6"}}>AddStudent</h1>
                ...
                <button style={{backgroundColor: "#1976d2",color:"#fff",borderRadius:"20px",padding:"0.6em 2em",border:"0",cursor:"pointer",margin:"1em",marginTop:"1em",marginRight:"1em",marginBottom:"1em",marginLeft:"1em",position: "relative",left: "130px"}}>Submit</button><br />
            </form>
        </div>
      </div>
    )
